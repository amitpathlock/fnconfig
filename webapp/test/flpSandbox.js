		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#pldacappsfnconfig-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"pldacappsfnconfig-display": {
								"semanticObject": "pldacappsfnconfig",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=pl.dac.apps.fnconfig",
									"url": sap.ui.require.toUrl("pl/dac/apps/fnconfig")
								}
							}
						}
					}
